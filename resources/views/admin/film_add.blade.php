...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ url('admin/film/add') }}" enctype="multipart/form-data" class="col-md-6 mx-auto">
                @csrf
                <div class="form-group">
                    <label for="judul">Judul Film</label>
                    <input type="text" name="judul" id="judul" value="{{ old('judul') }}" class="form-control" placeholder="Juduk Film" required>
                </div>
                <div class="form-group">
                    <label for="genre">Genre Film</label>
                    <input type="text" name="genre" id="genre" value="{{ old('genre') }}" class="form-control" placeholder="Genre Film" required>
                </div>
                <div class="form-group">
                    <label for="foto">Foto</label>
                    <input type="file" name="foto" id="foto" value="{{ old('foto') }}" accept="image/png, image/gif, image/jpeg, image/jpg" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="sinopsis">Sinopsis</label>
                    <textarea name="sinopsis" id="sinopsis" cols="30" rows="3" placeholder="Sinopsis" class="form-control" required>{{ old('sinopsis') }}</textarea>
                </div>
